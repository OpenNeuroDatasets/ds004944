...
performed with our neuromorphic processing pipeline: [https://doi.org/10.21203/rs.3.rs-3591328/v1](https://doi.org/10.21203/rs.3.rs-3591328/v1).
...
- derivative
 ...
 - ***task-SNN.npy:** SNN encoding of the ECoG recording.
 - ***task-EV.cvs:**  Annotations of the detected epileptiform patterns in the ECoG recording.

## Data Formats

Details of the neuromorphic processing pipeline can be found at [https://doi.org/10.21203/rs.3.rs-3591328/v1](https://doi.org/10.21203/rs.3.rs-3591328/v1).
...
The SNN file is formatted as follows:
 ...
 - neuronId: Number id of the SNN neuron. (referring to DYNAP-SE numbering convention from 0 to 1024) 
 - neuronCounter: Number id of the SNN neuron. (referring to sequential numbering from 0 to 40)
 - moduleName: Neural population (ACC_4_0; ACC_0_4), band (EEG; HFO) and module number (ch 0-7) of the neuron.
  - ACC_4_0 = ACC UP
  - ACC_0_4 = ACC DN
...
Please refer to the LICENSE file included with the dataset for information on licensing and usage restrictions.

## Contact Information

For inquiries or additional information, please contact Filippo Costa at Filippo.Costa@usz.ch.
